	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				ALAccount::addAccount($this->settings, 'aa8f317b71588ded7153f385d8dc3e49', 'fa21d1f801f31884531c11919a8a1c6d');
		ALAccount::updateApiPublicKey($this->settings, 'aa8f317b71588ded7153f385d8dc3e49');
			}
